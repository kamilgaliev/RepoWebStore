...
namespace WebStore.ServiceHosting.Controllers.Identity
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO ClaimInfo, [FromServices] WebStoreDB _db)
        {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo, [FromServices] WebStoreDB _db)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO ClaimInfo, [FromServices] WebStoreDB _db)
        {
            await _UserStore.RemoveClaimsAsync(ClaimInfo.User, ClaimInfo.Claims);
            await _db.SaveChangesAsync();
        }

        [HttpPost("GetUesersForClaim")]
        public async Task<IList<User>> GetUesersForClaimAsync([FromBody] Claim Claim) => await _UserStore.GetUsersForClaimAsync(Claim);
        #endregion
